//Generated:2022-08-29 20:22:42// 39-535
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_6286173 || '',
    GUID: window.ftGUID_6286173 || '99999999999',
    confID: window.ftConfID_6286173 || '0',
    ftReturn: window.ftReturn_6286173 || '',
    keyword: window.ftKeyword_6286173 || '',
    ftId: window.ftId_6286173 || '',
    imp: window.ftImp6286173,
    ftImpId: window.ftImp6286173 && window.ftImp6286173.impID || '',
    gdpr: window.ftImp6286173 && window.ftImp6286173.gdpr || '',
    gdpr_consent: window.ftImp6286173 && window.ftImp6286173.gdpr_consent || '',
    gdpr_pd: window.ftImp6286173 && window.ftImp6286173.gdpr_pd || '',
    us_privacy: window.ftImp6286173 && window.ftImp6286173.us_privacy || '',
    campaignID: '115739',
    cID: '155251',
    pID: '6286173',
    creativeID: '3972278',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115739&sid=20050&plc=6286173&num=&adid=&advid=&adsrv=29&btreg=6286173&btadsrv=flashtalking&crt=3972278&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]&auevent=[ftqs:[ft_dv]]"
    ],
    clickTags: [
      "https://servedby.flashtalking.com/click/8/115739;6286173;3972278;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/no/creativecloud/plans.html?plan=edu&sdid=TKZTLFVF&mv=display"
    ],
    placementDescription: 'QuantcastFY22EDULALEDUPurchaseDynamicNODSKBAN728x90',
    width: 728,
    height: 90,
    adType: 'custom_rule'.toLowerCase(),
    siteName: 'QuantcastAdobeDyn',
    divID: 'ftdiv6286173',
    phID: 'ftpos6286173',
    frameID: 'ftframe6286173',
    expID: 'ftexpframe6286173',
    altImgID: 'ftalt6286173',
    altText: 'Click here',
    altImgTarget: '_blank',
    altimghref: 'https://servedby.flashtalking.com/click/8/115739;6286173;3972278;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/no/creativecloud/plans.html?plan=edu&sdid=TKZTLFVF&mv=display',
    altImg: 'https://servedby.flashtalking.com/imp/8/115739;6286173;204;gif;QuantcastAdobeDyn;QuantcastFY22EDULALEDUPurchaseDynamicNODSKBAN728x90/?',
    viewableImpressionURL: 'https://servedby.flashtalking.com/imp/8/115739;6286173;271;pixel;QuantcastAdobeDyn;QuantcastFY22EDULALEDUPurchaseDynamicNODSKBAN728x90/?',
    stump: 'https://servedby.flashtalking.com',
    jsurl: 'http://cdn.flashtalking.com/xre/628/6286173/3972278/js/j-6286173-3972278.js',
    file: 'http://cdn.flashtalking.com/155251/3972278/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM: 'http://cdn.flashtalking.com',
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?224241758-6286173;3972278;',
    adVis: false ? 1 : 0,
    centreAd: false,
    mvt: false,
    segment: window.ftSegment_6286173 || '',
    segmentList: window.ftSegmentList_6286173 || [],
    ...
    baggyFrameLimit: 15,
    append: !!(window.ftImp6286173 && window.ftImp6286173.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m6286173') && /^https:/.test(document.getElementById('ftscript_m6286173').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m6286173'),
    ...
    qsVars: [
      ['ftguid', 'ftGUID_6286173'],
      ['ftcfid', 'ftConfID_6286173'],
      ['fttime', 'ftTimestamp_6286173'],
      ['ftsection', 'ftSection_6286173'],
      ['ftcustom', 'ftCustom_6286173'],
      ['ft_id', 'ftId_6286173'],
      ['ftimpid', 'ftImp6286173', 'impID'],
      ['gdpr', 'ftImp6286173', 'gdpr'],
      ['gdpr_consent', 'ftImp6286173', 'gdpr_consent'],
      ['gdpr_pd', 'ftImp6286173', 'gdpr_pd'],
      ['us_privacy', 'ftImp6286173', 'us_privacy']
    ]
  };
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_6286173").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_6286173").style.display = "none";
		    }
		});
	}
}(ft6286173));
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115739&l2=QuantcastAdobeDyn&l3=6286173&l4=3972278&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115739&l2=QuantcastAdobeDyn&l3=6286173&l4=3972278&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
...
(function(o) {
  ...
  // var windowDvVariable = window.ftClick_6286173;
  var windowDvVariable = "",
      // windowFtParams = window.ftParams_6001356;
      windowFtParams = window.ftParams_6286173;
